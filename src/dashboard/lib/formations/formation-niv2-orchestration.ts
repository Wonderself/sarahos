...
Pour créer votre assistant dans Freenzy, rendez-vous dans la section « Mes Agents » du dashboard. Cliquez sur « Créer un assistant », donnez-lui un nom et un emoji, puis rédigez votre system prompt. Vous pouvez tester l'assistant en temps réel avant de le déployer — chaque modification du prompt est instantanément reflétée dans les réponses.
