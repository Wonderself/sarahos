    ...
    <div style={{ height: 'calc(100dvh - 56px)', display: 'flex', flexDirection: 'column', background: '#0f172a', position: 'relative' }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 11, color: '#94a3b8', display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          {listeningStatus === 'speaking' && <span style={{ color: '#5b6cf7' }}>Parle...</span>}
        </div>
      </div>
        ...
        <div className={`visio-transcript-panel ${showTranscript ? 'open' : ''}`}>
          ...
          <div style={{ padding: '8px 12px', borderTop: '1px solid var(--border-primary)', display: 'flex', gap: 8, flexShrink: 0 }}>
            ...
            <button
              ...
              style={{ padding: '8px 16px', borderRadius: 8, border: 'none', background: '#5b6cf7', color: 'white', fontSize: 12, fontWeight: 700, cursor: processing ? 'wait' : 'pointer', opacity: processing ? 0.6 : 1 }}
            >
              ↵
            </button>
          </div>
