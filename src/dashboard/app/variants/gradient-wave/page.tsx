...
const ACTION_COSTS = [
  { icon: 'chat', action: 'Chat avec agent IA', model: 'Haiku', count: '100 chats', color: '#06b6d4' },
  ...
  { icon: 'chat', action: 'WhatsApp Business IA', model: 'Haiku', count: '125 msgs', color: '#06b6d4' },
...
// ─── Live activity feed
const ACTIVITY = [
  { icon: 'call', text: 'Appel traité · lead qualifié', agent: 'Répondeur', color: '#06b6d4', ago: '2 min' },
  ...
  { icon: 'chat', text: '12 messages WhatsApp traités', agent: 'Assistante', color: '#06b6d4', ago: '39 min' },
...
export default function LandingPage() {
  ...
  // Page view on mount
  useEffect(() => { trackPageView('/variants/gradient-wave', 'gradient-wave', audience); }, [audience]);
  ...
  return (
    <>
      ...
      <main style={{ paddingTop: 0 }}>
          ...
          <div style={{ maxWidth: 700, margin: '0 auto', position: 'relative', zIndex: 1 }}>
            <div style={{ marginBottom: 10, marginTop: -8 }}>
              <span style={{
                ...
                <span className="lp-green-badge-full">Super-app du futur &middot; Social &middot; Jeux &middot; IA &middot; Tout-en-un</span>
                <span className="lp-green-badge-mobile">Super-app du futur &middot; Social &middot; IA &middot; Tout-en-un</span>
              </span>
            </div>
            ...
            <div style={{ textAlign: 'center', marginBottom: 16 }}>
              ...
              <Link href={ctaHref} className="lp-cta-primary" onClick={() => trackCtaClick('hero_cta', '/login?mode=register', audience, '/variants/gradient-wave')} style={{
        ...
        <div style={{ flexShrink: 0, background: '#0f0720', borderBottom: '1px solid rgba(255,255,255,0.05)', padding: '10px 0' }}>
        ...
        <section style={{ background: '#f0f0ff', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              ...
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#1d1d1f', letterSpacing: -1.5, marginBottom: 6, ...gradientTextStyle }}>
                Tout converge ici.
              </h2>
              <p style={{ color: '#86868b', fontSize: 14 }}>L&apos;&eacute;volution naturelle : toutes vos apps, <span className="fz-accent-word">fusion&eacute;es</span> en une exp&eacute;rience unique.</p>
            </div>
        ...
        <section style={{ background: '#1a0e3a', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 860, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              ...
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#fff', letterSpacing: -1.5, ...gradientTextStyle }}>
        ...
        <section style={{ background: '#f0f0ff', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 28 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 600, color: '#7c3aed', letterSpacing: 4, textTransform: 'uppercase', marginBottom: 10 }}>Comment ca marche</p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#1d1d1f', letterSpacing: -1.5, marginBottom: 6, ...gradientTextStyle }}>
                Fluide. Intelligent. Instantan&eacute;.
              </h2>
              ...
              {TECH_FEATURES.map((t, i) => (
                <div key={i} className="lp-app-card" style={{ padding: '20px 22px' }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                    {t.points.map((p, j) => (
                      <span key={j} style={{
                        fontSize: 11, color: '#4b5563', background: '#e8e0ff',
            ...
            <div className="lp-whatsapp-grid">
              <div>
                ...
                <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#1d1d1f', letterSpacing: -1.5, marginBottom: 12 }}>
                  Messagerie <span className="fz-accent-word" style={{ color: '#06b6d4' }}>nouvelle g&eacute;n&eacute;ration</span>.
                </h2>
                <p style={{ fontSize: 14, color: '#6b7280', lineHeight: 1.65, marginBottom: 20 }}>
                  WhatsApp, Telegram, Messenger &mdash; Freenzy unifie toutes vos conversations dans un <span className="fz-accent-word" style={{ color: '#06b6d4' }}>flux intelligent</span>.
                </p>
        ...
        <section style={{ background: '#f0f0ff', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 40 }}>
              ...
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#1d1d1f', letterSpacing: -1.5, marginBottom: 12, ...gradientTextStyle }}>
                Votre Freenzy, unique.
              </h2>
              <p style={{ fontSize: 15, color: '#6b7280', lineHeight: 1.65, maxWidth: 580, margin: '0 auto' }}>
                L&apos;app s&apos;adapte, &eacute;volue, apprend. Chaque interaction la rend plus <span className="fz-accent-word" style={{ color: '#8b5cf6' }}>vous</span>.
              </p>
            </div>
          ...
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 40 }}>
              ...
              <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.38)', marginTop: 8, lineHeight: 1.6, maxWidth: 520, marginLeft: 'auto', marginRight: 'auto' }}>
                Imaginez un monde o&ugrave; une seule app remplace Facebook, Instagram, TikTok, ChatGPT, Notion, et tous les autres. C&apos;est <span className="fz-accent-word" style={{ color: '#c4b5fd' }}>Freenzy</span>. Et ce n&apos;est que le <span className="fz-accent-word" style={{ color: '#c4b5fd' }}>d&eacute;but</span>.
              </p>
            </div>
            <div className="lp-scenario-steps" style={{ gap: 16 }}>
              {[
                { icon: 'diamond', title: 'Évolution constante', desc: 'Freenzy se transforme sans cesse. Chaque mise à jour apporte de nouvelles fonctionnalités, de nouveaux modules, de nouvelles possibilités. Le futur, livré chaque semaine.', color: '#06b6d4' },
                { icon: 'psychology', title: 'IA qui apprend de vous', desc: 'Plus vous utilisez Freenzy, plus elle vous comprend. Vos préférences, vos habitudes, votre ton — l\'app s\'adapte en permanence pour devenir votre extension naturelle.', color: '#f59e0b' },
        ...
        <section ref={faqRef} id="faq" style={{ background: '#f0f0ff', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 820, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              ...
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#1d1d1f', letterSpacing: -1, ...gradientTextStyle }}>
        ...
        <section ref={ctaRef} style={{
          ...
          <div style={{ maxWidth: 600, margin: '0 auto', position: 'relative', zIndex: 1 }}>
            ...
            <Link href={ctaHref} className="lp-cta-primary" onClick={() => trackCtaClick('final_cta', '/login?mode=register', audience, '/variants/gradient-wave')} style={{
