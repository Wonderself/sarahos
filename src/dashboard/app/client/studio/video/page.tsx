  ...
  return (
    <div style={{ height: 'calc(100vh - 56px)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        display: 'flex', alignItems: 'center', gap: 10, background: 'white', flexWrap: 'wrap',
      }}>
        <a href="/client/studio" style={{ fontSize: 12, color: '#6b7280', textDecoration: 'none' }}>
          ← Studio
        </a>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              background: 'white', color: '#92400e', cursor: 'pointer', fontWeight: 600,
            }}
          >
            Annuler
          </button>
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ padding: '0 20px 12px', background: '#fafafa' }}>
            <button
              ...
              style={{
                ...
                fontSize: 11, fontWeight: 600, color: '#9ca3af', textAlign: 'left',
              }}
            >
              <span style={{
            ...
            {advancedOpen && (
              <div style={{
                ...
                {/* Public cible */}
                <div>
                  <label style={{ fontSize: 10, fontWeight: 700, color: '#6b7280', display: 'block', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.3 }}>
                    Public cible
                  </label>
                  <input type="text" value={advPublicCible} onChange={e => setAdvPublicCible(e.target.value)}
                    placeholder="Entrepreneurs, mamans..." style={{ width: '100%', padding: '6px 9px', borderRadius: 7, border: '1px solid #e5e7eb', fontSize: 11, outline: 'none', boxSizing: 'border-box' }} />
                </div>
                ...
                <div>
                  ...
                  <select value={advObjectif} onChange={e => setAdvObjectif(e.target.value)}
                    style={{ width: '100%', padding: '6px 9px', borderRadius: 7, border: '1px solid #e5e7eb', fontSize: 11, outline: 'none', background: 'white', boxSizing: 'border-box' }}>
                ...
                <div>
                  ...
                  <input type="text" value={advMusique} onChange={e => setAdvMusique(e.target.value)}
                    placeholder="Corporate, énergique..." style={{ width: '100%', padding: '6px 9px', borderRadius: 7, border: '1px solid #e5e7eb', fontSize: 11, outline: 'none', boxSizing: 'border-box' }} />
                </div>
                ...
                <div>
                  ...
                  <input type="text" value={advContraintes} onChange={e => setAdvContraintes(e.target.value)}
                    placeholder="Texte obligatoire, logo..." style={{ width: '100%', padding: '6px 9px', borderRadius: 7, border: '1px solid #e5e7eb', fontSize: 11, outline: 'none', boxSizing: 'border-box' }} />
                </div>
              </div>
            )}
          </div>
          ...
          <div style={{ maxHeight: '36vh', overflowY: 'auto', borderTop: '2px solid #e5e7eb' }}>
            <AgentRequestQueue
              type="video"
