  ...
  return (
    ...
    <div style={{ display: 'flex', minHeight: '100dvh', paddingTop: isImpersonating ? 40 : 0 }}>
      ...
      >
        ...
        <div className="sidebar-footer-wrap" style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px', paddingBottom: 'max(8px, env(safe-area-inset-bottom, 0px))', borderTop: '1px solid #E5E5E5', flexShrink: 0 }}>
          {session ? (
            <>
              <div style={{
