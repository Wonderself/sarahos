...
export const PAGE_META: Record<string, PageMeta> = {
  ...
  actions: {
    ...
    subtitle: 'Actions proposées par vos outils IA',
    helpText: 'Vos outils IA proposent des actions à valider. Acceptez, refusez ou déléguez chaque proposition.',
  },
  agents: {
    emoji: '🤖',
    title: 'Outils IA',
    subtitle: 'Vos outils IA spécialisés',
    helpText: 'Gérez vos outils IA actifs, créez des outils personnalisés, configurez leurs comportements.',
  },
  'agents-create': {
    emoji: '✨',
    title: 'Créer un outil IA',
    subtitle: 'Configurez votre outil IA personnalisé',
    helpText: 'Créez un outil IA sur mesure en quelques étapes : identité, domaine, comportement, test et déploiement.',
  },
  formations: {
    emoji: '🎓',
    title: 'Formations',
  ...
  analytics: {
    ...
    helpText: 'Suivez votre consommation de tokens, crédits et l\'activité de vos outils IA.',
  },
  finances: {
    emoji: '💳',
    title: 'Finances',
  ...
  notifications: {
    ...
    helpText: 'Tous les messages importants de vos outils IA, du système et de votre activité.',
  },
  discussions: {
    emoji: '🧠',
    title: 'Discussions Profondes',
    subtitle: 'Explorez des sujets en profondeur',
    helpText: 'Des conversations thématiques approfondies sur des sujets complexes. Utilise le modèle le plus puissant (Opus).',
  },
  games: {
    emoji: '🕹️',
    title: 'Arcade',
  ...
  marketplace: {
    emoji: '🛒',
    title: 'Marketplace',
    subtitle: 'Découvrez de nouveaux outils IA',
    helpText: 'Parcourez les outils IA disponibles et ajoutez-les à votre espace. Certains sont gratuits, d\'autres premium.',
  },
  budget: {
    emoji: '💰',
    title: 'Mon Budget',
  ...
  personal: {
    emoji: '👤',
    title: 'Mes Outils',
    subtitle: 'Gérez vos outils IA',
    helpText: 'Activez, désactivez et configurez vos outils IA business et personnels.',
  },
  'agents-customize': {
    emoji: '🎨',
    title: 'Personnaliser',
    subtitle: 'Configurez vos outils IA',
    helpText: 'Ajustez le comportement, le ton et les capacités de chaque outil IA.',
  },
  meeting: {
    emoji: '📆',
    title: 'Réunion',
...
export const FEATURE_SECTIONS: FeatureSection[] = [
  {
    ...
    items: [
      ...
      { id: 'personal', emoji: '👤', label: 'Mes Outils', desc: 'Gérez vos outils IA', href: '/client/personal' },
      { id: 'agents-customize', emoji: '🎨', label: 'Personnaliser', desc: 'Configurez vos outils IA', href: '/client/agents/customize' },
      { id: 'agents', emoji: '🤖', label: 'Outils IA', desc: 'Tous les outils IA disponibles', href: '/client/agents' },
      ...
      { id: 'actions', emoji: '⚡', label: 'Actions', desc: 'Propositions de vos outils IA', href: '/client/actions' },
    ],
  },
  {
    id: 'moi',
