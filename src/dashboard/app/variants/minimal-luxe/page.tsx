...
const ACTION_COSTS = [
  { icon: 'chat', action: 'Chat avec agent IA', model: 'Haiku', count: '100 chats', color: '#7c9a5e' },
  { icon: 'mail', action: 'Email professionnel', model: 'Sonnet', count: '45 emails', color: '#c8a97e' },
  { icon: 'phone_iphone', action: 'Post réseaux sociaux', model: 'Haiku', count: '62 posts', color: '#3b82f6' },
  { icon: 'description', action: 'Document complet', model: 'Sonnet', count: '14 docs', color: '#c8a97e' },
  ...
  { icon: 'chat', action: 'WhatsApp Business IA', model: 'Haiku', count: '125 msgs', color: '#7c9a5e' },
...
// ─── Live activity feed
const ACTIVITY = [
  { icon: 'call', text: 'Appel traité · lead qualifié', agent: 'Répondeur', color: '#7c9a5e', ago: '2 min' },
  { icon: 'mail', text: 'Proposition commerciale envoyée', agent: 'Commercial', color: '#c8a97e', ago: '4 min' },
  ...
  { icon: 'description', text: 'NDA bilingue généré', agent: 'Juridique', color: '#c8a97e', ago: '31 min' },
  { icon: 'chat', text: '12 messages WhatsApp traités', agent: 'Assistante', color: '#7c9a5e', ago: '39 min' },
...
// ═══════════════════════════════════════════════════════════
export default function MinimalLuxePage() {
      ...
      <main style={{ paddingTop: 56 }}>
        ...
        <section style={{
          ...
          <div style={{
            ...
            background: 'radial-gradient(ellipse, rgba(200,169,126,0.08) 0%, transparent 68%)',
            pointerEvents: 'none',
          }} />
          ...
          <div style={{ maxWidth: 700, margin: '0 auto', position: 'relative', zIndex: 1 }}>
            <div style={{ marginBottom: 10, marginTop: -8 }}>
              <span style={{
                ...
                background: 'rgba(124,154,94,0.1)', border: '1px solid rgba(124,154,94,0.22)',
                color: '#a8c686', padding: '5px 16px', borderRadius: 40,
                fontSize: 11, fontWeight: 500, whiteSpace: 'nowrap', letterSpacing: 0.5,
              }}>
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: '#7c9a5e', display: 'inline-block', flexShrink: 0 }} />
                <span className="lp-green-badge-full">L&apos;app unique &middot; Elegante &middot; Compl&egrave;te &middot; Gratuite</span>
                <span className="lp-green-badge-mobile">L&apos;app unique &middot; Elegante &middot; Compl&egrave;te &middot; Gratuite</span>
              </span>
            </div>
            ...
            <h1 className="lp-gradient-h1" style={{
              ...
              background: 'linear-gradient(135deg, #e8ddd0 0%, #c8a97e 50%, #8b7355 100%)',
            ...
            <div style={{ textAlign: 'center', marginBottom: 16 }}>
              ...
              <Link href="/plans" style={{
                ...
                color: 'rgba(255,255,255,0.58)', borderRadius: 10, fontWeight: 500,
                fontSize: 'clamp(11px, 3vw, 14px)', textDecoration: 'none',
                transition: 'all 0.3s ease',
              }}>
                Explorer les possibilit&eacute;s
              </Link>
              </div>
            </div>
            ...
            <div className="lp-ticker">
              {[...ACTIVITY, ...ACTIVITY].map((item, i) => (
                <div key={i} className="lp-ticker-item lp-activity-chip" style={{ gap: 8, padding: '6px 14px' }}>
                  ...
                  <span style={{ color: item.color, fontWeight: 600, fontSize: 11 }}>{item.agent}</span>
                  <span style={{ color: 'rgba(255,255,255,0.40)', fontSize: 11 }}>{item.text}</span>
                  <span style={{ color: 'rgba(255,255,255,0.15)', fontSize: 10 }}>&middot; {item.ago}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section style={{ background: '#faf8f5', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 500, color: '#c8a97e', letterSpacing: 6, marginBottom: 10 }}>Outils</p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 600, color: '#1a1a1a', letterSpacing: -1.5, marginBottom: 6 }}>
                Chaque <span style={{ color: '#c8a97e' }}>outil</span>, pens&eacute; pour vous.
              </h2>
              <p style={{ color: '#86868b', fontSize: 14 }}>La quintessence de chaque application, dans un <span style={{ color: '#c8a97e' }}>&eacute;crin unique</span>.</p>
            </div>
              ...
              {TOOL_CATEGORIES.map((cat, i) => (
                <button
                  ...
                  style={{
                    ...
                    background: toolTab === i ? '#c8a97e' : '#f5f0ea',
                    color: toolTab === i ? '#1a1715' : '#6b7280',
                    boxShadow: toolTab === i ? '0 1px 3px rgba(0,0,0,0.04)' : 'none',
                    transition: 'all 0.3s ease',
            ...
            <div style={{
              ...
              {TOOL_CATEGORIES[toolTab].tools.map((tool, i) => (
                <div key={i} className="lp-app-card" style={{ display: 'flex', alignItems: 'flex-start', gap: 14, padding: '20px 18px', background: '#fff', border: '1px solid #e8e0d8', boxShadow: '0 1px 3px rgba(0,0,0,0.04)', borderRadius: 14 }}>
                  <div style={{
                    width: 44, height: 44, borderRadius: 12, flexShrink: 0,
                    background: '#faf5ef', border: '1px solid #e8e0d8',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}>
                    <span className="material-symbols-rounded" style={{ fontSize: 22, color: '#8b7355' }}>{tool.icon}</span>
                  </div>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                      <span style={{ fontFamily: 'var(--font-display)', fontSize: 14, fontWeight: 600, color: '#1a1a1a' }}>{tool.name}</span>
                      <span style={{
                        fontSize: 10, fontWeight: 600, color: '#7c9a5e',
                        background: 'rgba(124,154,94,0.08)', border: '1px solid rgba(124,154,94,0.18)',
        ...
        {/* ══ DEMO INTERACTIVE ══════════════════════════════════ */}
        <section style={{ background: '#1a1715', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 860, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 500, color: '#c8a97e', letterSpacing: 6, marginBottom: 10 }}>En action</p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 600, color: '#fff', letterSpacing: -1.5 }}>
                L&apos;&eacute;l&eacute;gance de l&apos;<span style={{ color: '#c8a97e' }}>automatisation</span>.
              </h2>
            </div>
              ...
              {DEMO_SCENARIOS.map((s, i) => (
                <button
                  ...
                  style={{
                    ...
                    border: 'none', cursor: 'pointer', whiteSpace: 'nowrap', minHeight: 44,
                    background: demoTab === i ? s.color : 'rgba(255,255,255,0.04)',
                    color: demoTab === i ? '#fff' : 'rgba(255,255,255,0.40)',
                    boxShadow: 'none',
                    transition: 'all 0.3s ease',
                  }}
                >
            ...
            <div style={{
              background: '#1a1715', border: '1px solid rgba(200,169,126,0.12)',
              ...
              <div style={{
                ...
                <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.18)', marginLeft: 6 }}>
              ...
              <div style={{ padding: '20px' }}>
                <div style={{ display: 'flex', gap: 10, marginBottom: 16 }}>
                  <div style={{
                    ...
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}><span className="material-symbols-rounded" style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>person</span></div>
                  <div style={{
                    background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(200,169,126,0.1)',
                    borderRadius: '0 12px 12px 12px', padding: '9px 13px',
                    fontSize: 13, color: 'rgba(255,255,255,0.65)', lineHeight: 1.55, maxWidth: 520,
                  }}>
                    {demo.prompt}
                  </div>
                </div>
                <div style={{ display: 'flex', gap: 10 }}>
                  <div style={{
                    width: 26, height: 26, borderRadius: '50%', flexShrink: 0,
                    background: `${demo.color}1a`, border: `1px solid ${demo.color}33`,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}><span className="material-symbols-rounded" style={{ fontSize: 11 }}>bolt</span></div>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                      <span style={{ fontSize: 11, color: demo.color, fontWeight: 600, letterSpacing: 0.5 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                      {demo.lines.map((line, j) => (
                        <div key={j} style={{
                          ...
                          borderLeft: `2px solid ${demo.color}44`,
                          borderRadius: '0 8px 8px 0', padding: '7px 11px',
                          display: 'flex', gap: 10, alignItems: 'baseline',
                        }}>
                          <span style={{ fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.20)', textTransform: 'uppercase', letterSpacing: 0.4, flexShrink: 0, minWidth: 58 }}>
                            {line.label}
                          </span>
                          <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.60)' }}>{line.text}</span>
                        </div>
                      ))}
                    </div>
                    <div style={{ marginTop: 8, fontSize: 11, color: 'rgba(255,255,255,0.15)' }}>{demo.model}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section style={{ background: '#f5f0ea', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 28 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 500, color: '#c8a97e', letterSpacing: 6, marginBottom: 10 }}>Comment &ccedil;a marche</p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 600, color: '#1a1a1a', letterSpacing: -1.5, marginBottom: 6 }}>
                <span style={{ color: '#c8a97e' }}>Simple</span>. <span style={{ color: '#8b7355' }}>Raffin&eacute;</span>. <span style={{ color: '#c8a97e' }}>Imm&eacute;diat</span>.
              </h2>
              <p style={{ color: '#86868b', fontSize: 14 }}>Vos agents traitent tout, <span style={{ color: '#c8a97e' }}>24h/24</span>. Voici ce que &ccedil;a donne.</p>
            </div>

            {/* Scenarios concrets */}
            <div className="lp-scenario-steps" style={{ gap: 16, marginBottom: 40 }}>
              {SCENARIOS.map((s, i) => (
                <div key={i} className="lp-app-card" style={{ background: '#fff', border: '1px solid #e8e0d8', boxShadow: '0 1px 3px rgba(0,0,0,0.04)', borderRadius: 14 }}>
                  <div style={{ width: 8, height: 8, borderRadius: '50%', background: s.color, marginBottom: 14 }} />
                  <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 16, fontWeight: 600, color: '#1a1a1a', marginBottom: 8 }}>{s.title}</h3>
            ...
            <div style={{ textAlign: 'center', marginBottom: 20 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 500, color: '#9ca3af', letterSpacing: 6 }}>Propuls&eacute; par</p>
            </div>
            <div className="lp-scenario-steps" style={{ gap: 14 }}>
              {TECH_FEATURES.map((t, i) => (
                <div key={i} className="lp-app-card" style={{ padding: '20px 22px', background: '#fff', border: '1px solid #e8e0d8', boxShadow: '0 1px 3px rgba(0,0,0,0.04)', borderRadius: 14 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                    <div style={{ width: 8, height: 8, borderRadius: '50%', background: t.color, flexShrink: 0 }} />
                    <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 14, fontWeight: 600, color: '#1a1a1a' }}>{t.title}</h3>
                  </div>
                  <p style={{ fontSize: 12, color: '#6b7280', lineHeight: 1.6, marginBottom: 10 }}>{t.desc}</p>
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                    {t.points.map((p, j) => (
                      <span key={j} style={{
                        fontSize: 11, color: '#4b5563', background: '#f5f0ea',
                        padding: '3px 10px', borderRadius: 20, border: '1px solid #e8e0d8',
                      }}>
                        {p}
                      </span>
                    ))}
        ...
        <section style={{ background: '#faf8f5', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div className="lp-whatsapp-grid">
              <div>
                <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 500, color: '#7c9a5e', letterSpacing: 6, marginBottom: 10 }}>WhatsApp</p>
                <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 600, color: '#1a1a1a', letterSpacing: -1.5, marginBottom: 12 }}>
                  WhatsApp, <span style={{ color: '#7c9a5e' }}>naturellement</span>.
                </h2>
                <p style={{ fontSize: 14, color: '#6b7280', lineHeight: 1.65, marginBottom: 20 }}>
                  Vos conversations, vos agents, votre assistant — tout cohabite <span style={{ color: '#7c9a5e' }}>harmonieusement</span>.
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {['Résumés automatiques', 'Instructions en langage naturel', 'Notifications intelligentes', 'Fichiers et documents'].map((f, i) => (
                    <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'center', fontSize: 13, color: '#4b5563' }}>
                      <span className="material-symbols-rounded" style={{ color: '#7c9a5e', fontSize: 16 }}>check_circle</span> {f}
                    </div>
                  ))}
                </div>
              </div>
              <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: 14 }}>
                  <span style={{ fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.7)' }}>Freenzy Assistant</span>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        ...
        <section style={{ background: '#f5f0ea', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 40 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 500, color: '#8b7355', letterSpacing: 6, marginBottom: 10 }}>
                Sur mesure
              </p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 600, color: '#1a1a1a', letterSpacing: -1.5, marginBottom: 12 }}>
                Fa&ccedil;onnez votre <span style={{ color: '#8b7355' }}>espace</span>.
              </h2>
              <p style={{ fontSize: 15, color: '#6b7280', lineHeight: 1.65, maxWidth: 580, margin: '0 auto' }}>
                Freenzy s&apos;adapte &agrave; vous. Chaque module, chaque agent, chaque d&eacute;tail refl&egrave;te votre <span style={{ color: '#8b7355' }}>style</span>.
              </p>
            </div>
            ...
            <div className="lp-custom-grid" style={{
              ...
              {/* Self-service */}
              <div className="lp-app-card" style={{ padding: '32px 28px', background: '#fff', border: '1px solid #e8e0d8', boxShadow: '0 1px 3px rgba(0,0,0,0.04)', borderRadius: 14 }}>
                <span className="material-symbols-rounded" style={{ fontSize: 32, marginBottom: 16, display: 'block', color: '#8b7355' }}>build</span>
                <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 17, fontWeight: 600, color: '#1a1a1a', marginBottom: 8 }}>
                  Vous cr&eacute;ez
                </h3>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {[
                    ...
                    <div key={i} style={{ fontSize: 12, color: '#4b5563', display: 'flex', gap: 8, alignItems: 'center' }}>
                      <span className="material-symbols-rounded" style={{ color: '#8b7355', fontSize: 14 }}>check_circle</span> {p}
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* On-demand */}
              <div className="lp-app-card" style={{ padding: '32px 28px', background: '#fff', border: '1px solid #e8e0d8', boxShadow: '0 1px 3px rgba(0,0,0,0.04)', borderRadius: 14 }}>
                <span className="material-symbols-rounded" style={{ fontSize: 32, marginBottom: 16, display: 'block', color: '#8b7355' }}>target</span>
                <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 17, fontWeight: 600, color: '#1a1a1a', marginBottom: 8 }}>
            ...
            {/* Examples */}
            <div className="lp-app-card" style={{ padding: '24px 28px', background: '#fff', border: '1px solid #e8e0d8', boxShadow: '0 1px 3px rgba(0,0,0,0.04)', borderRadius: 14 }}>
              <p style={{ fontSize: 12, fontWeight: 600, color: '#9ca3af', letterSpacing: 6, marginBottom: 16 }}>
              ...
              <div className="lp-custom-examples" style={{
                ...
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <span className="material-symbols-rounded" style={{ fontSize: 22, marginBottom: 8, display: 'block', color: '#8b7355' }}>{ex.icon}</span>
                    <div style={{ fontSize: 13, fontWeight: 600, color: '#1a1a1a', marginBottom: 4 }}>{ex.name}</div>
        ...
        <section style={{ background: '#1a1715', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 40 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 500, color: '#c8a97e', letterSpacing: 6, marginBottom: 10 }}>
                L&apos;exp&eacute;rience Freenzy
              </p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 600, color: '#fff', letterSpacing: -1.5 }}>
                Le luxe de la <span style={{ color: '#c8a97e' }}>simplicit&eacute;</span>.
              </h2>
              <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.35)', marginTop: 8, lineHeight: 1.6, maxWidth: 520, marginLeft: 'auto', marginRight: 'auto' }}>
                L&agrave; o&ugrave; d&apos;autres empilent les applications, Freenzy <span style={{ color: '#c8a97e' }}>unifie</span>. R&eacute;seau social, jeux, IA, productivit&eacute; — une seule interface d&apos;une <span style={{ color: '#c8a97e' }}>&eacute;l&eacute;gance rare</span>.
              </p>
            </div>
            <div className="lp-scenario-steps" style={{ gap: 16 }}>
              {[
                { icon: 'diamond', title: 'Zéro commission', desc: 'Le prix officiel des fournisseurs IA, sans marge. Transparence absolue sur chaque crédit consommé. L\'élégance de la simplicité tarifaire.', color: '#7c9a5e' },
                { icon: 'lock_open', title: 'Sans engagement', desc: 'Ni abonnement, ni contrainte. Rechargez vos crédits selon vos besoins — ils n\'expirent jamais. La liberté comme principe.', color: '#f59e0b' },
                ...
                <div key={i} className="lp-app-card-dark" style={{ border: '1px solid rgba(200,169,126,0.1)', borderRadius: 14 }}>
                  ...
                  <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 15, fontWeight: 600, color: '#fff', marginBottom: 8 }}>{item.title}</h3>
                  <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.40)', lineHeight: 1.65 }}>{item.desc}</p>
                </div>
              ))}
            </div>
        ...
        <section id="faq" style={{ background: '#f5f0ea', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 820, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              ...
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 600, color: '#1a1a1a', letterSpacing: -1 }}>
                Questions <span style={{ color: '#c8a97e' }}>fr&eacute;quentes</span>.
              </h2>
              ...
              {FAQ_CATEGORIES.map((cat, ci) => (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: faqCat === ci ? '0 1px 3px rgba(0,0,0,0.04)' : '0 1px 3px rgba(0,0,0,0.04)',
                    transition: 'all 0.3s ease',
                  }}
                >
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderLeft: `3px solid ${isOpen ? catColor : '#d1c8bc'}`,
                      borderRadius: 11, padding: '16px 18px',
                      transition: 'all 0.3s ease', cursor: 'pointer',
                    }}
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12 }}>
                      <div style={{ fontSize: 14, fontWeight: 600, color: '#1a1a1a' }}>{faq.q}</div>
                      <div style={{
                        width: 24, height: 24, borderRadius: '50%', flexShrink: 0,
                        background: isOpen ? catColor : '#f5f0ea',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontFamily: 'var(--font-display)', fontSize: 14, fontWeight: 600, color: isOpen ? '#fff' : '#9ca3af',
                        transition: 'all 0.3s ease',
                      }}>
                        {isOpen ? '\u2212' : '+'}
                      </div>
        ...
        <section style={{
          ...
          <div style={{
            ...
            background: 'radial-gradient(ellipse, rgba(200,169,126,0.06) 0%, transparent 68%)',
            pointerEvents: 'none',
          }} />
          <div style={{ maxWidth: 600, margin: '0 auto', position: 'relative', zIndex: 1 }}>
            <p className="fz-logo-text fz-logo-text-dark" style={{ fontSize: 12, letterSpacing: 6, marginBottom: 16, opacity: 0.3 }}>
              freenzy.io
            </p>
            <h2 style={{
              ...
              Votre monde digital,<br />
              <span style={{ color: '#c8a97e' }}>unifi&eacute;.</span>
            </h2>
