...
import { CreateUserButton } from './actions';
...
export default async function UsersPage() {
  ...
  const topConsumers = [...users]
    .sort((a, b) => b.dailyApiCalls - a.dailyApiCalls)
    .slice(0, 5);
  ...
  return (
    <div className="admin-page-scrollable">
        ...
        <div className="card">
          ...
          {topConsumers.map((u, i) => (
            ...
            >
              ...
              <div className="avatar avatar-sm" style={{ background: avatarColor(u.email) }}>
      ...
      <p className="text-xs text-muted mt-8">
        API: POST /admin/users · PATCH /admin/users/:id · DELETE /admin/users/:id · POST /admin/users/:id/reset-key
      </p>
    </div>
  );
}
