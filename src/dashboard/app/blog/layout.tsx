...
export const metadata: Metadata = {
  ...
  description: 'Guides pratiques, tutoriels et cas d\'usage pour tirer le meilleur parti de l\'IA dans votre entreprise. Répondeur IA, agents spécialisés, automatisation, RGPD.',
