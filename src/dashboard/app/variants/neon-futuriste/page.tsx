...
const ACTION_COSTS = [
  { icon: 'chat', action: 'Chat avec agent IA', model: 'Haiku', count: '100 chats', color: '#b8ff00' },
  { icon: 'mail', action: 'Email professionnel', model: 'Sonnet', count: '45 emails', color: '#00f0ff' },
  { icon: 'phone_iphone', action: 'Post réseaux sociaux', model: 'Haiku', count: '62 posts', color: '#3b82f6' },
  { icon: 'description', action: 'Document complet', model: 'Sonnet', count: '14 docs', color: '#00f0ff' },
  ...
  { icon: 'chat', action: 'WhatsApp Business IA', model: 'Haiku', count: '125 msgs', color: '#b8ff00' },
...
// ─── Live activity feed
const ACTIVITY = [
  { icon: 'call', text: 'Appel traité · lead qualifié', agent: 'Répondeur', color: '#b8ff00', ago: '2 min' },
  { icon: 'mail', text: 'Proposition commerciale envoyée', agent: 'Commercial', color: '#00f0ff', ago: '4 min' },
  ...
  { icon: 'description', text: 'NDA bilingue généré', agent: 'Juridique', color: '#00f0ff', ago: '31 min' },
  { icon: 'chat', text: '12 messages WhatsApp traités', agent: 'Assistante', color: '#b8ff00', ago: '39 min' },
...
export default function LandingPage() {
  ...
  // Page view on mount
  useEffect(() => { trackPageView('/variants/neon-futuriste', 'neon-futuriste', audience); }, [audience]);
  const variantAngle = VARIANT_ANGLES.find(v => v.variantId === 'neon-futuriste');
  const variantHero = audience && variantAngle ? variantAngle.heroes[audience] : null;
  const ctaLabel = config?.cta.label || 'Rejoindre la révolution';
      ...
      <main style={{ paddingTop: 0 }}>
        ...
        <section ref={heroRef} style={{
          ...
          <div className="lp-hero-glow-anim" style={{
            ...
            background: 'radial-gradient(ellipse, rgba(255,0,170,0.1) 0%, transparent 68%)',
            pointerEvents: 'none',
          }} />
          ...
          <div style={{ maxWidth: 700, margin: '0 auto', position: 'relative', zIndex: 1 }}>
            <div style={{ marginBottom: 10, marginTop: -8 }}>
              <span style={{
                ...
                background: 'rgba(184,255,0,0.1)', border: '1px solid rgba(184,255,0,0.22)',
                color: '#d4ff66', padding: '5px 16px', borderRadius: 40,
                fontSize: 11, fontWeight: 700, whiteSpace: 'nowrap',
              }}>
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: '#b8ff00', display: 'inline-block', flexShrink: 0 }} />
                <span className="lp-green-badge-full">La super-app &middot; IA &middot; Social &middot; Jeux &middot; Tout-en-un</span>
                <span className="lp-green-badge-mobile">Super-app &middot; IA &middot; Social &middot; Jeux &middot; Tout-en-un</span>
              </span>
            </div>
            ...
            <h1 className="lp-gradient-h1" style={{
              ...
              {variantHero ? variantHero.headline : <>UNE SEULE APP.<br />POUR TOUT.</>}
            </h1>

            <p style={{
              fontFamily: 'var(--font-display)', fontSize: 'clamp(13px, 1.6vw, 15px)',
              color: '#00f0ff', fontWeight: 600,
            ...
            <p style={{
              ...
              {variantHero ? variantHero.subheadline : <>Freenzy remplace tout. R&eacute;seaux sociaux, messagerie, IA, jeux, shopping, streaming — une seule app. La derni&egrave;re que vous t&eacute;l&eacute;chargerez.</>}
            </p>

            <div style={{ textAlign: 'center', marginBottom: 16 }}>
              <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
              <Link href={ctaHref} className="lp-cta-primary" onClick={() => trackCtaClick('hero_cta', '/login?mode=register', audience, '/variants/neon-futuriste')} style={{
                padding: '12px 20px', background: '#00f0ff', color: '#0a001a',
              ...
              <Link href="/plans" style={{
                ...
                background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(0,240,255,0.2)',
        ...
        <section style={{ background: '#0d0024', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 600, color: '#00f0ff', letterSpacing: 4, textTransform: 'uppercase', marginBottom: 10 }}>OUTILS</p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#fff', letterSpacing: 1, marginBottom: 6, textTransform: 'uppercase' }}>
                L&apos;ARSENAL <span className="fz-accent-word" style={{ color: '#00f0ff' }}>COMPLET</span>.
              </h2>
              <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 14 }}>Chaque outil des autres apps. En <span className="fz-accent-word" style={{ color: '#00f0ff' }}>mieux</span>.</p>
            </div>
              ...
              {TOOL_CATEGORIES.map((cat, i) => (
                <button
                  ...
                  style={{
                    ...
                    background: toolTab === i ? '#00f0ff' : 'rgba(0,240,255,0.06)',
                    color: toolTab === i ? '#0a001a' : 'rgba(255,255,255,0.5)',
                    boxShadow: toolTab === i ? '0 0 20px rgba(0,240,255,0.3)' : 'none',
                    transition: 'all 0.2s',
            ...
            <div style={{
              ...
              {TOOL_CATEGORIES[toolTab].tools.map((tool, i) => (
                <div key={i} className="lp-app-card" style={{ display: 'flex', alignItems: 'flex-start', gap: 14, padding: '20px 18px', background: 'rgba(0,240,255,0.04)', border: '1px solid rgba(0,240,255,0.1)', boxShadow: '0 0 30px rgba(0,240,255,0.05)' }}>
                  <div style={{
                    width: 44, height: 44, borderRadius: 12, flexShrink: 0,
                    background: 'rgba(0,240,255,0.08)', border: '1px solid rgba(0,240,255,0.15)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}>
                    <span className="material-symbols-rounded" style={{ fontSize: 22, color: '#00f0ff' }}>{tool.icon}</span>
                  </div>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                      <span style={{ fontFamily: 'var(--font-display)', fontSize: 14, fontWeight: 700, color: '#fff' }}>{tool.name}</span>
                      <span style={{
                        fontSize: 10, fontWeight: 700, color: '#b8ff00',
                        background: 'rgba(184,255,0,0.1)', border: '1px solid rgba(184,255,0,0.22)',
                        padding: '2px 8px', borderRadius: 20,
                      }}>Inclus</span>
                    </div>
                    <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', lineHeight: 1.55 }}>{tool.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        {/* ══ DEMO INTERACTIVE ══════════════════════════════════ */}
        <section style={{ background: '#0a001a', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 860, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 600, color: '#00f0ff', letterSpacing: 4, textTransform: 'uppercase', marginBottom: 10 }}>EN ACTION</p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#fff', letterSpacing: 1, textTransform: 'uppercase' }}>
                REGARDEZ. C&apos;EST <span className="fz-accent-word" style={{ color: '#00f0ff' }}>D&Eacute;J&Agrave; FAIT</span>.
              </h2>
            </div>
              ...
              {DEMO_SCENARIOS.map((s, i) => (
                <button
                  ...
                  style={{
                    ...
                    border: 'none', cursor: 'pointer', whiteSpace: 'nowrap', minHeight: 44,
                    background: demoTab === i ? s.color : 'rgba(0,240,255,0.06)',
                    color: demoTab === i ? '#0a001a' : 'rgba(255,255,255,0.45)',
            ...
            <div style={{
              background: '#060012', border: '1px solid rgba(0,240,255,0.12)',
              borderRadius: 16, overflow: 'hidden',
              boxShadow: '0 0 30px rgba(0,240,255,0.05)',
            }}>
              <div style={{
                background: 'rgba(0,240,255,0.03)', padding: '9px 16px',
        ...
        <section style={{ background: '#0d0024', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 28 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 600, color: '#00f0ff', letterSpacing: 4, textTransform: 'uppercase', marginBottom: 10 }}>COMMENT CA MARCHE</p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#fff', letterSpacing: 1, marginBottom: 6, textTransform: 'uppercase' }}>
                <span className="fz-accent-word" style={{ color: '#00f0ff' }}>RAPIDE</span>. <span className="fz-accent-word" style={{ color: '#ff00aa' }}>BRUTAL</span>. <span className="fz-accent-word" style={{ color: '#b8ff00' }}>EFFICACE</span>.
              </h2>
              <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 14 }}>Vos agents traitent tout, <span className="fz-accent-word" style={{ color: '#00f0ff' }}>24h/24</span>. Voici ce que &ccedil;a donne.</p>
            </div>

            {/* Scenarios concrets */}
            <div className="lp-scenario-steps" style={{ gap: 16, marginBottom: 40 }}>
              {SCENARIOS.map((s, i) => (
                <div key={i} className="lp-app-card" style={{ background: 'rgba(0,240,255,0.04)', border: '1px solid rgba(0,240,255,0.1)', boxShadow: '0 0 30px rgba(0,240,255,0.05)' }}>
                  <div style={{ width: 8, height: 8, borderRadius: '50%', background: s.color, marginBottom: 14 }} />
                  <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 16, fontWeight: 700, color: '#fff', marginBottom: 8, letterSpacing: 1, textTransform: 'uppercase' }}>{s.title}</h3>
                  <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', lineHeight: 1.6, marginBottom: 16 }}>{s.desc}</p>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    {s.steps.map((step, j) => (
                  ...
                  <div style={{ marginTop: 14, fontSize: 11, color: 'rgba(255,255,255,0.3)' }}>{s.tech}</div>
                </div>
              ))}
            </div>
            ...
            <div style={{ textAlign: 'center', marginBottom: 20 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 600, color: 'rgba(255,255,255,0.3)', letterSpacing: 3, textTransform: 'uppercase' }}>Propulse par</p>
            </div>
            <div className="lp-scenario-steps" style={{ gap: 14 }}>
              {TECH_FEATURES.map((t, i) => (
                <div key={i} className="lp-app-card" style={{ padding: '20px 22px', background: 'rgba(0,240,255,0.04)', border: '1px solid rgba(0,240,255,0.1)', boxShadow: '0 0 30px rgba(0,240,255,0.05)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                    <div style={{ width: 8, height: 8, borderRadius: '50%', background: t.color, flexShrink: 0 }} />
                    <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 14, fontWeight: 700, color: '#fff' }}>{t.title}</h3>
                  </div>
                  <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', lineHeight: 1.6, marginBottom: 10 }}>{t.desc}</p>
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                    {t.points.map((p, j) => (
                      <span key={j} style={{
                        fontSize: 11, color: 'rgba(255,255,255,0.6)', background: 'rgba(0,240,255,0.06)',
                        padding: '3px 10px', borderRadius: 20, border: '1px solid rgba(0,240,255,0.1)',
                      }}>
                        {p}
                      </span>
                    ))}
        ...
        <section style={{ background: '#0a001a', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div className="lp-whatsapp-grid">
              <div>
                <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 600, color: '#b8ff00', letterSpacing: 4, textTransform: 'uppercase', marginBottom: 10 }}>WHATSAPP</p>
                <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#fff', letterSpacing: 1, marginBottom: 12, textTransform: 'uppercase' }}>
                  WHATSAPP? <span className="fz-accent-word" style={{ color: '#b8ff00' }}>INT&Eacute;GR&Eacute;</span>.
                </h2>
                <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 1.65, marginBottom: 20 }}>
                  Freenzy absorbe WhatsApp. Pilotez tout depuis une <span className="fz-accent-word" style={{ color: '#b8ff00' }}>interface unique</span>.
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {['Résumés automatiques', 'Instructions en langage naturel', 'Notifications intelligentes', 'Fichiers et documents'].map((f, i) => (
                    <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'center', fontSize: 13, color: 'rgba(255,255,255,0.6)' }}>
                      <span className="material-symbols-rounded" style={{ color: '#b8ff00', fontSize: 16 }}>check_circle</span> {f}
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section style={{ background: '#0d0024', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 40 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 600, color: '#ff00aa', letterSpacing: 4, textTransform: 'uppercase', marginBottom: 10 }}>
                SUR MESURE
              </p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#fff', letterSpacing: 1, marginBottom: 12, textTransform: 'uppercase' }}>
                CR&Eacute;EZ VOTRE <span className="fz-accent-word" style={{ color: '#ff00aa' }}>UNIVERS</span>.
              </h2>
              <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.5)', lineHeight: 1.65, maxWidth: 580, margin: '0 auto' }}>
                Chaque utilisateur customise son Freenzy. Modules, agents, th&egrave;mes — c&apos;est <span className="fz-accent-word" style={{ color: '#ff00aa' }}>VOTRE</span> app.
              </p>
            </div>
            ...
            <div className="lp-custom-grid" style={{
              ...
              {/* Self-service */}
              <div className="lp-app-card" style={{ padding: '32px 28px', background: 'rgba(0,240,255,0.04)', border: '1px solid rgba(0,240,255,0.1)', boxShadow: '0 0 30px rgba(0,240,255,0.05)' }}>
                <span className="material-symbols-rounded" style={{ fontSize: 32, marginBottom: 16, display: 'block', color: '#00f0ff' }}>build</span>
                <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 17, fontWeight: 700, color: '#fff', marginBottom: 8, letterSpacing: 1, textTransform: 'uppercase' }}>
                  Vous cr&eacute;ez
                </h3>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {[
                    ...
                    <div key={i} style={{ fontSize: 12, color: 'rgba(255,255,255,0.6)', display: 'flex', gap: 8, alignItems: 'center' }}>
                      <span className="material-symbols-rounded" style={{ color: '#ff00aa', fontSize: 14 }}>check_circle</span> {p}
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* On-demand */}
              <div className="lp-app-card" style={{ padding: '32px 28px', background: 'rgba(0,240,255,0.04)', border: '1px solid rgba(0,240,255,0.1)', boxShadow: '0 0 30px rgba(0,240,255,0.05)' }}>
                <span className="material-symbols-rounded" style={{ fontSize: 32, marginBottom: 16, display: 'block', color: '#00f0ff' }}>target</span>
                <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 17, fontWeight: 700, color: '#fff', marginBottom: 8, letterSpacing: 1, textTransform: 'uppercase' }}>
            ...
            {/* Examples */}
            <div className="lp-app-card" style={{ padding: '24px 28px', background: 'rgba(0,240,255,0.04)', border: '1px solid rgba(0,240,255,0.1)' }}>
              <p style={{ fontSize: 12, fontWeight: 700, color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', letterSpacing: 2, marginBottom: 16 }}>
              ...
              <div className="lp-custom-examples" style={{
                ...
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <span className="material-symbols-rounded" style={{ fontSize: 22, marginBottom: 8, display: 'block', color: '#00f0ff' }}>{ex.icon}</span>
                    <div style={{ fontSize: 13, fontWeight: 700, color: '#fff', marginBottom: 4 }}>{ex.name}</div>
                    <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', lineHeight: 1.55 }}>{ex.desc}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section style={{ background: '#0a001a', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 40 }}>
              <p style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 600, color: '#00f0ff', letterSpacing: 4, textTransform: 'uppercase', marginBottom: 10 }}>
                POURQUOI FREENZY VA TOUT CHANGER
              </p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#fff', letterSpacing: 1, textTransform: 'uppercase' }}>
                L&apos;APP DE <span className="fz-accent-word" style={{ color: '#00f0ff' }}>DEMAIN</span>. AUJOURD&apos;HUI.
              </h2>
              <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.38)', marginTop: 8, lineHeight: 1.6, maxWidth: 520, marginLeft: 'auto', marginRight: 'auto' }}>
                Facebook a eu son heure. Instagram aussi. Freenzy, c&apos;est la <span className="fz-accent-word" style={{ color: '#00f0ff' }}>convergence</span> : r&eacute;seau social, jeux, IA, productivit&eacute;, cr&eacute;ativit&eacute;, le tout dans une <span className="fz-accent-word" style={{ color: '#00f0ff' }}>interface unique</span>.
              </p>
            </div>
            <div className="lp-scenario-steps" style={{ gap: 16 }}>
              {[
                { icon: 'diamond', title: '0% de commission', desc: 'Freenzy remplace vos abonnements Netflix, Spotify, ChatGPT, Canva, LinkedIn Premium. Tout est intégré. Pas de markup, pas de marge cachée.', color: '#b8ff00' },
                ...
                { icon: 'language', title: 'Toutes les IA du marché', desc: 'Claude, GPT, Gemini, Llama, Grok, Mistral — et tous les prochains dès leur sortie. Chaque agent choisit le meilleur modèle pour chaque tâche.', color: '#00f0ff' },
                ...
                { icon: 'smart_toy', title: '72+ agents spécialisés', desc: 'Chaque domaine a son expert : social, gaming, business, créatif… Plus le marketplace avec 50 templates prêts à l\'emploi. Une seule app au lieu de 20.', color: '#9333ea' },
              ].map((item, i) => (
                <div key={i} className="lp-app-card-dark" style={{ background: 'rgba(0,240,255,0.04)', border: '1px solid rgba(0,240,255,0.1)', boxShadow: '0 0 30px rgba(0,240,255,0.05)' }}>
                  <span className="material-symbols-rounded" style={{ fontSize: 28, marginBottom: 12, display: 'block', color: item.color }}>{item.icon}</span>
                  <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 15, fontWeight: 700, color: '#fff', marginBottom: 8, letterSpacing: 1, textTransform: 'uppercase' }}>{item.title}</h3>
        ...
        <section id="faq" ref={faqRef} style={{ background: '#0d0024', padding: 'clamp(32px, 4vw, 56px) 24px' }}>
          <div style={{ maxWidth: 820, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 32 }}>
              ...
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(22px, 3.5vw, 36px)', fontWeight: 700, color: '#fff', letterSpacing: 1, textTransform: 'uppercase' }}>
                <span className="fz-accent-word" style={{ color: '#f97316' }}>TOUTES</span> VOS QUESTIONS.
              </h2>
              ...
              {orderedFaq.map((cat, ci) => (
                <button
                  ...
                  style={{
                    ...
                    background: faqCat === ci ? cat.color : 'rgba(0,240,255,0.06)',
                    color: faqCat === ci ? '#0a001a' : 'rgba(255,255,255,0.5)',
                    boxShadow: faqCat === ci ? `0 0 20px ${cat.color}33` : 'none',
                    transition: 'all 0.2s',
                  }}
                >
              ...
              {orderedFaq[faqCat].questions.map((faq, i) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      background: isOpen ? 'rgba(0,240,255,0.06)' : 'rgba(0,240,255,0.02)',
                      border: isOpen ? `1.5px solid ${catColor}40` : '1px solid rgba(0,240,255,0.08)',
                      borderLeft: `3px solid ${isOpen ? catColor : 'rgba(255,255,255,0.1)'}`,
                      borderRadius: 11, padding: '16px 18px',
                      transition: 'all 0.2s', cursor: 'pointer',
                    }}
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12 }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: '#fff' }}>{faq.q}</div>
                      <div style={{
                        width: 24, height: 24, borderRadius: '50%', flexShrink: 0,
                        background: isOpen ? catColor : 'rgba(0,240,255,0.1)',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontFamily: 'var(--font-display)', fontSize: 14, fontWeight: 700, color: isOpen ? '#0a001a' : 'rgba(255,255,255,0.3)',
                        transition: 'all 0.2s',
                      }}>
                        {isOpen ? '−' : '+'}
                      </div>
        ...
        <section ref={ctaRef} style={{
          background: 'linear-gradient(165deg, #0a001a 0%, #120028 50%, #0a001a 100%)',
          ...
          <div style={{ maxWidth: 600, margin: '0 auto', position: 'relative', zIndex: 1 }}>
            ...
            <h2 style={{
              ...
              letterSpacing: 1, lineHeight: 1.05, marginBottom: 14,
              textTransform: 'uppercase',
            }}>
              Votre vie digitale<br />
              <span className="fz-accent-word" style={{ color: '#00f0ff' }}>unifi&eacute;e.</span>
            </h2>
            <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.36)', marginBottom: 32 }}>
              <span style={{ color: '#00f0ff', fontWeight: 700 }}>{totalAgents} agents IA</span>. Toutes les IA du march&eacute;. <span style={{ color: '#00f0ff', fontWeight: 700 }}>0% de commission</span>. Sans carte bancaire.
            </p>
            <Link href={ctaHref} className="lp-cta-primary" onClick={() => trackCtaClick('final_cta', '/login?mode=register', audience, '/variants/neon-futuriste')} style={{
              display: 'inline-block', padding: '15px 40px',
              background: '#00f0ff', color: '#0a001a',
