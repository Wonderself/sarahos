...
const INTERVIEW_QUESTIONS: InterviewQuestion[] = [
  {
    ...
    field: 'companyName',
    emoji: '🏢',
    question: 'Pour commencer, quel est le nom de votre entreprise ?',
  ...
  },
  {
    ...
    field: 'industry',
    emoji: '🧭',
    question: 'Dans quel secteur d\'activite etes-vous ?',
  ...
  },
  {
    ...
    field: 'employeeCount',
    emoji: '👥',
    question: 'Combien de personnes dans votre equipe ?',
  ...
  },
  {
    ...
    field: 'mission',
    emoji: '🎯',
    question: 'Quelle est la mission de votre entreprise ?',
  ...
  },
  {
    ...
    emoji: '⚠️',
    question: 'Quels sont vos principaux defis en ce moment ?',
  ...
  },
  {
    ...
    emoji: '🚀',
    question: 'Derniere question ! Quels sont vos objectifs pour les 3-6 prochains mois ?',
...
const COPILOT_TIPS: CopilotTip[] = [
  {
    ...
    message: 'Ici votre copilote 🧑‍✈️ Je suis la pour vous guider. On commence par remplir votre profil ? Ca prend 2 minutes et vos assistants seront bien plus efficaces.',
  ...
  },
  {
    ...
    message: 'Votre profil n\'est rempli qu\'en partie. Vos assistants seront plus pertinents avec des infos completes. Je peux vous poser quelques questions rapides ?',
    condition: () => {
  ...
  },
  {
    id: 'documents_ready',
    emoji: '✅',
    title: 'Documents prets !',
    message: 'Vos documents sont pre-remplis avec vos informations. Choisissez un modele ci-dessous.',
  ...
  },
  {
    ...
    message: '50 modeles vous attendent. Completez votre profil pour qu\'ils soient automatiquement personnalises.',
    pages: ['/client/documents'],
    condition: () => {
      try { return !localStorage.getItem('fz_company_profile'); } catch { return true; }
    },
  ...
  },
  {
    id: 'chat_intro',
    emoji: '💬',
    title: 'Discutez avec vos assistants',
    message: 'Choisissez un assistant et lancez la conversation. Ils connaissent votre entreprise et s\'adaptent a vous.',
    pages: ['/client/chat'],
    priority: 6,
  },
  {
  ...
  },
  {
    id: 'repondeur_intro',
    emoji: '📞',
    title: 'Repondeur intelligent',
    message: 'Le repondeur gere vos appels quand vous etes occupe. Configurez-le et il prend les messages automatiquement.',
  ...
  },
  {
    ...
    message: 'Planifiez et publiez sur tous vos reseaux depuis un seul endroit.',
    pages: ['/client/social'],
    priority: 7,
  },
  {
    ...
    emoji: '🎯',
    title: 'Strategie',
    message: 'Definissez vos objectifs. Vos assistants proposeront des actions concretes pour les atteindre.',
  ...
  },
  {
    ...
    message: 'Recevez chaque matin un resume personnalise : taches du jour, actualites, rappels importants.',
    pages: ['/client/reveil'],
    priority: 7,
  },
  {
    ...
    message: 'Explorez des sujets complexes avec le modele le plus puissant (Opus). Ideal pour la reflexion strategique.',
  ...
  },
  {
    ...
    message: 'Tous vos assistants IA sont ici. Activez ceux dont vous avez besoin selon votre activite.',
  ...
  },
  {
    ...
    emoji: '⚡',
    title: 'Credits bas',
    message: 'Vos credits sont presque epuises. Rechargez pour continuer a utiliser vos assistants.',
    action: { label: 'Recharger', href: '/client/finances' },
    condition: () => {
      try {
  ...
  },
  {
    ...
    emoji: '💡',
    title: 'A decouvrir',
    message: 'Vous n\'avez pas encore essaye toutes les fonctionnalites. Le Studio, les Discussions, le Repondeur... explorez !',
    pages: ['/client/dashboard'],
    priority: 10,
  },
];
...
const CONGRATULATIONS = [
  'Bien recu ! C\'est note. ✅',
  'Parfait ! On continue. 📋',
  'Super, un champ de plus ! 👍',
  'Vos assistants vont adorer cette info. ✅',
  'Excellent ! Le profil se complete. 💪',
  'C\'est enregistre ! Question suivante. 📝',
  'Tres bien ! On enchaine. ✅',
  'Bravo ! Encore quelques infos et c\'est bon. 🚀',
];
